#ifndef STAGE2_LOADER
#error "STAGE2_LOADER must be defined"
#endif

typedef long ssize_t;
typedef unsigned long size_t;

#define TOO_MANY_PARAMETERS_MESSAGE "[dynld] Too many parameters!\n"
...
void _start_c(long *p) {
    ...
    if (argc >= 250) {
        syscall3(__NR_write,2,(size_t)TOO_MANY_PARAMETERS_MESSAGE,sizeof(TOO_MANY_PARAMETERS_MESSAGE) - 1);
